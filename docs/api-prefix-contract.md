...
Tài liệu này xác định ranh giới giữa các endpoint dựa vào vai trò. Mục tiêu là tránh gọi sai quyền, tạo endpoint trùng và trộn API giữa các module frontend.
